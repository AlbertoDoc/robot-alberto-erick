...
public class AlbertoErickRobotGA extends AdvancedRobot {
private static final int HIT_NUMBERS_TO_SWITCH_MOVEMENT = 5;
private static final long HIT_EVALUATE_INTERVAL = 8886;
private static final long HIT_WALL_EVALUATE_INTERVAL = 4669;
int numberOfHits = 0;
long firstHitTime = 0;
...
setMaxVelocity(4.258287428314286);
if (isNearWall() != WallNear.NONE || getVelocity() == 0) {
directionMovementSign *= -1;directionMovementSign *= -1;
}
...
setMaxVelocity(3.8539549527045995);
setTurnRight(setNormalizeAngleForBearing(enemyBearing + 90));
execute();
