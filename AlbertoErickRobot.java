...
public class AlbertoErickRobot extends AdvancedRobot {
    private static final int HIT_NUMBERS_TO_SWITCH_MOVEMENT = 5;
    private static final long HIT_EVALUATE_INTERVAL = 8886; // 3 segundos em milissegundos
    private static final long HIT_WALL_EVALUATE_INTERVAL = 4669; // 6 segundos em milissegundos
    int numberOfHits = 0;
    long firstHitTime = 0;
    ...
    public void doMoveInCircle() {
        ...
        setMaxVelocity(4.258287428314286); // Velocidade gerada por algoritmo genetico
    ...
    public void doMoveInZigZag() {
        ...
        setMaxVelocity(3.8539549527045995); // Velocidade gerada por algoritmo genetico
    ...
    double calculateBulletPower(double distance) {
        return Math.max(2.5724285554177673 / (distance / 41.21509269985089), 0.5);
    }
